...
public class LabotaryTrayScreenHandler extends ScreenHandler {
    ...
    public final LabotaryTrayBlockEntity blockEntity;
    public LabotaryTrayScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
        this(syncId,inventory,inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(2));
    }

    public LabotaryTrayScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.LABOTARY_TRAY_SCREEN_HANDLER, syncId);
