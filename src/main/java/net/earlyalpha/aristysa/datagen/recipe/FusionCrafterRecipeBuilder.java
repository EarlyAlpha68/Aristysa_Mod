...
public class FusionCrafterRecipeBuilder implements CraftingRecipeJsonBuilder {
    private final Item result;
    private final Ingredient[] ingredients;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.create();

    public FusionCrafterRecipeBuilder(ItemConvertible[] ingredients, ItemConvertible result, int count) {
    ...
    public static class JsonBuilder implements RecipeJsonProvider {
        ...
        public Identifier getRecipeId() {
            return new Identifier(Aristysa.MOD_ID,
                    Registries.ITEM.getId(this.result).getPath() + "_from_fusion_crafter");
        }
